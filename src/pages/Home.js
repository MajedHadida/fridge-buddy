...
const Home = () => {
    return(
        <div className="bg-gray-800 p-10">
            <div className="grid grids-cols-3 gap-10">
                <div className="col-span-2 row-span-1 col-start-1 col-end-3  bg-none text-white text-7xl pl-10 pt-20">
                    Welcome to FridgeBuddy, username
                </div>
                <div className="col-span-1 row-span-1 col-start-3 col-end-3 flex justify-center pt-20">
                ...
                <div className="col-span-1 row-span-1 col-start-3 col-end-3 flex justify-center">
                    <div className="card bg-base-100 w-72 shadow-xl">
